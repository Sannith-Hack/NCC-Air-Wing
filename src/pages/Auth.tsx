...
const Auth = () => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast.error("User already exists", { description: "A user with this email already exists. Please sign in." });
    } else {
      toast.info("Check your email", { description: "A verification link has been sent to your email address." });
      setView('sign-in');
    }
    setLoading(false);
  };
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast.success("Success", { description: "Signed in successfully." });
      navigate("/");
    }
    setLoading(false);
  };
  ...
  const handlePasswordReset = async (e: React.FormEvent) => {
    ...
    if (error) {
        ...
        toast.info("Check your email", { description: "A password reset link has been sent to your email." });
        setView('sign-in');
    }
    setLoading(false);
  };
